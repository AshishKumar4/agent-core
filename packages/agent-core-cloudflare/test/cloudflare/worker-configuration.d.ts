/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.test.jsonc test/cloudflare/worker-configuration.d.ts` (hash: 6f5591024153b1255458ca9d39e4ada4)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "TestActorDurableObject" | "EnvironmentProviderDurableObject";
	}
