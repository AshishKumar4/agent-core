/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.test.jsonc test/cloudflare/worker-configuration.d.ts` (hash: a6c8c78f13647da6d4e92f1909504cd0)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "TestActorDurableObject" | "EnvironmentProviderDurableObject" | "SlateProviderDurableObject" | "PermitTenantDurableObject" | "PermitTargetDurableObject";
	}
