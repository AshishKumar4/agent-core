/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.test.jsonc test/cloudflare/worker-configuration.d.ts` (hash: dbae637eb5c4f4455027cfb59398bd8c)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "TestActorDurableObject" | "EnvironmentProviderDurableObject" | "SlateProviderDurableObject";
	}
