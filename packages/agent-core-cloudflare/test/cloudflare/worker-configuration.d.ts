/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.test.jsonc test/cloudflare/worker-configuration.d.ts` (hash: 506469faa4749ecf522e07572ce217d2)
...
interface __BaseEnv_Env {
	...
	PERMIT_TENANTS: DurableObjectNamespace<import("./worker").PermitTenantDurableObject>;
	PERMIT_TARGETS: DurableObjectNamespace<import("./worker").PermitTargetDurableObject>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "TestActorDurableObject" | "EnvironmentProviderDurableObject" | "SlateProviderDurableObject" | "PermitTenantDurableObject" | "PermitTargetDurableObject" | "PlacementRegistryDurableObject" | "RunWorkspaceDurableObject" | "RunDurableObject";
	}
