/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.test.jsonc test/cloudflare/worker-configuration.d.ts` (hash: f2c7f599f0c6229f0102160a5d86aa78)
// Runtime types generated with workerd@1.20260708.1 2026-07-10 nodejs_compat
interface __BaseEnv_Env {
    CONTENT: R2Bucket;
    DELIVERIES: Queue;
    LOADER: WorkerLoader;
    ACTORS: DurableObjectNamespace<import("./worker").TestActorDurableObject>;
    ENVIRONMENTS: DurableObjectNamespace<import("./worker").EnvironmentProviderDurableObject>;
    SLATES: DurableObjectNamespace<import("./worker").SlateProviderDurableObject>;
    PLACEMENTS: DurableObjectNamespace<import("./worker").PlacementRegistryDurableObject>;
    RUN_WORKSPACES: DurableObjectNamespace<import("./worker").RunWorkspaceDurableObject>;
    RUN_OBJECTS: DurableObjectNamespace<import("./worker").RunDurableObject>;
    TENANT_AUTHORITY: DurableObjectNamespace<import("./worker").TenantAuthorityDurableObject>;
    TARGET_MEDIATION: DurableObjectNamespace<import("./worker").TargetMediationDurableObject>;
    PROVIDERS: DurableObjectNamespace<import("./worker").ProviderActorDurableObject>;
}
declare namespace Cloudflare {
    interface GlobalProps {
        mainModule: typeof import("./worker");
        durableNamespaces:
            | "TestActorDurableObject"
            | "EnvironmentProviderDurableObject"
            | "SlateProviderDurableObject"
            | "PlacementRegistryDurableObject"
            | "RunWorkspaceDurableObject"
            | "RunDurableObject"
            | "TenantAuthorityDurableObject"
            | "TargetMediationDurableObject"
            | "ProviderActorDurableObject";
    }
