/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=live/wrangler.live.jsonc live/worker-configuration.d.ts` (hash: 33602dde87e02e41520c75c659171d19)
// Runtime types generated with workerd@1.20260708.1 2026-07-10 nodejs_compat
interface __BaseEnv_Env {
	CONTENT: R2Bucket;
	DELIVERIES: Queue;
	ENVIRONMENTS: DurableObjectNamespace<import("./worker").LiveEnvironmentHarness>;
	SLATES: DurableObjectNamespace<import("./worker").LiveSlateHarness>;
	RUNTIME: DurableObjectNamespace<import("./worker").LiveRuntimeHarness>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "LiveEnvironmentHarness" | "LiveSlateHarness" | "LiveRuntimeHarness";
	}
