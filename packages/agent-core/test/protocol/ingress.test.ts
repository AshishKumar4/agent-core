...
test("a forged capability cannot replace transport authentication", { tags: "p0" }, () => {
    const harness = new CounterHarness();
    Object.defineProperty(harness.dispatcher, "authenticationBypass", {
    ...
    const forgedInit = {
        ...
        leaseForMilliseconds: 60_000,
        authenticationBypass: harness.content
    };
