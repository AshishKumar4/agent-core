...
test("[workspace.event-provenance] codec and ownership evidence", { tags: "p1" }, () => {
...
test("[workspace.action-descriptor] codec and ownership evidence", { tags: "p1" }, () => {
...
test("[workspace.subscription] codec and ownership evidence", { tags: "p1" }, () => {
...
test("[workspace.route-reservation] codec and ownership evidence", { tags: "p1" }, () => {
...
test("[workspace.route-projection] codec and ownership evidence", { tags: "p1" }, () => {
...
test("[workspace.route-delivery] codec and ownership evidence", { tags: "p1" }, () => {
...
test("[workspace.view] codec and ownership evidence", { tags: "p1" }, () => {
    const value = viewFixture(0, "registry");
    expect(View.encode(View.decode(View.encode(value)))).toEqual(View.encode(value));
});

test("[workspace.view-delta] codec and ownership evidence", { tags: "p1" }, () => {
...
test("[workspace.content-retention-reference] codec and ownership evidence", { tags: "p1" }, () => {
...
test("[workspace.inbox-reference] codec and ownership evidence", { tags: "p1" }, () => {
