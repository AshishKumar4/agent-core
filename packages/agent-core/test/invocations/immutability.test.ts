...
describe("invocation record immutability", () => {
    test(
        "[C13-PREPARED-WHOLE-DIGEST] detaches PreparedInvocation structural references before digesting",
        { tags: "p0" },
        () => {
    ...
    test(
        "[C13-PREPARED-APPROVAL-FIRST-ATTEMPT] freezes claim, attempt, admission, and Approval state aliases",
        { tags: "p0" },
        () => {
