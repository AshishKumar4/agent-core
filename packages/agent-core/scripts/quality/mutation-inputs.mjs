...
// for a provably identical outcome, which is how a ratchet stops being run.
import { createHash } from "node:crypto";
import { existsSync, readFileSync, readdirSync, statSync } from "node:fs";
import { relative, resolve } from "node:path";
import mutationVitestConfig from "../../vitest.mutation.config.mjs";
import { globMatches, packageRoot } from "./project.mjs";
...
export function mutationFingerprint(area) {
    const files = [
