...
| Integrated admission and settlement | `AC-COMPOSED-001` | designated direct admission plus an abstract distributed mediated-permit LTS: Tenant-local issuance against current authority, lossy/duplicating/reordering transport, exact issued-record authentication, volatile-auth reset, and target-local nonce-consume plus EffectAttempt/audit atomicity. Canonical reachability includes runtime authority administration and proves every reachable attempt has exact issued permit evidence; the abstract permit binds the modeled whole PreparedInvocation, claim, reservation, binding generation, fence, actor, nonce, and time fields, not every concrete §10.3 wire field. Settlement retains its constructive exact-obligation witness; no concrete transaction or refinement claim |
